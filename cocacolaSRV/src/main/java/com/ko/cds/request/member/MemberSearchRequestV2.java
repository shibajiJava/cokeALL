...
public class MemberSearchRequestV2 {
	...
	@NotNull
	@MaxLength(value=1)
	@QueryParam("socialSearch")
	private String socialSearch;
	...
	public String getSocialSearch() {
		//System.out.println(socialSearch);
		return socialSearch;
	}
	public void setSocialSearch(String socialSearch) {
		//System.out.println(socialSearch);
