package com.ko.cds.dao.admin.survey.test;
...
@Component
@Transactional
public class PostSurveyAdminDAOTest extends CDSTest{
	private static Logger log = LoggerFactory.getLogger(PostSurveyAdminDAOTest.class);
	@Autowired
	...
	@Test
	@Rollback(true)
	public void testWithallparametersAndSurveyId(){
