...
@Component
@Transactional
public class GetQuestionAdminRequestDAOtest extends CDSTest{
	private static Logger log = LoggerFactory.getLogger(GetQuestionAdminRequestDAOtest.class);
	@Autowired
	...
	public void testWithoutquestionID(){
		...
		GetQuestionAdminRequest getrequest = new GetQuestionAdminRequest();
		surveyDAO.getQuestions(getrequest);
	}
	
	@Test
	@Rollback(true)
	public void testWithquestionID(){
		@SuppressWarnings("deprecation")
		Date mydate = new Date("2014-12-20T12:29:02.000Z");
		BigInteger Value= BigInteger.valueOf(45454545);
		GetQuestionAdminRequest getrequest = new GetQuestionAdminRequest();
		getrequest.setQuestionID(11);
		surveyDAO.getQuestions(getrequest);
	}
