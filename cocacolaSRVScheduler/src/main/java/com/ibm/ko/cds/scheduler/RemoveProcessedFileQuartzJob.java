 ...
 */
@Component
public class RemoveProcessedFileQuartzJob extends QuartzJobBean implements StatefulJob{

	private MetricsSchHelper metricsSchHelper;
	
	private static final Logger logger = LoggerFactory
			.getLogger(RemoveProcessedFileQuartzJob.class);
		/**
	...
	protected void executeInternal(JobExecutionContext ctx)
		   ...
		   // Do the actual work
			metricsSchHelper.deleteProcessedFiles();
